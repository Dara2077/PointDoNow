...
public class Point
{
    ...
    /** checks if two points are exactly the same location
     * (probably need another "equals" for checking if points are
     * about the same place...
     * @param other - a Point
     * @return true if they are exactly equal at both coordinate
     */
